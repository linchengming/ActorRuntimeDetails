...
class FMyBlueprintRuntimeItemDragDropAction : public FGraphSchemaActionDragDropAction
{
public:
	DRAG_DROP_OPERATOR_TYPE(FMyBlueprintRuntimeItemDragDropAction, FGraphSchemaActionDragDropAction)
...
protected:
	 /** Constructor */
	FMyBlueprintRuntimeItemDragDropAction();
